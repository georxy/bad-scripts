...
btt4 = ''
btt5 = Button(root, text="Niche filter", command=click_niches, font=("Arial", 12))
btt6 = Button(root, text="Most used words", command=click_m_used_kw, font=("Arial", 12))
btt7 = Button(root, text="Location filter", command=location_click, font=("Arial", 12))
btt8 = Button(root, text="Backlink check", command=backlink_click, font=("Arial", 12))
btt9 = Button(root, text="Email generator", command=click_email, font=("Arial", 12))
btt10 = Button(root, text="бля", command=error_log, font=("Arial", 12))

e = Entry(borderwidth=6, font=("Arial", 14))
e.grid(row=0, column=0)
e_2 = Entry(borderwidth=6, font=("Arial", 14))
